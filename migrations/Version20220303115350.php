 ...
 */
final class Version20220303115350 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, date_rec DATE NOT NULL, type LONGTEXT NOT NULL, description LONGTEXT NOT NULL, etat LONGTEXT NOT NULL, INDEX IDX_CE606404BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
