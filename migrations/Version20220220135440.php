 ...
 */
final class Version20220220135440 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit ADD category_id INT DEFAULT NULL, CHANGE prix prix VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE produit DROP category_id, CHANGE prix prix DOUBLE PRECISION NOT NULL');
    }
}
